...
You can find the API for yourself [here](https://docs.magicthegathering.io/) and see the code I used to generate these graphs [here](https://github.com/FBIagent42/magic_data_set/tree/main). Good luck with the web scraping and I hope this little example helped!